    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center px-6 max-w-5xl mx-auto">
        ...
        <motion.button
          ...
          className="inline-flex items-center gap-3 px-10 py-4 btn-crimson font-body text-sm tracking-widest uppercase transition-all duration-300 group rounded-sm"
        >
          Explore Her World
